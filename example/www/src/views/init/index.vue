<template>
  <div class="init_page">
    <div class="init_page_panle">
      ...
      >
        <div>
          <div class="hello_title">IRISADMIN</div>
      ...
      >
        <el-form ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="host">
            <el-input v-model="form.sql.host" placeholder="请输入数据库链接" />
          </el-form-item>
          <el-form-item label="port">
            <el-input v-model="form.sql.port" placeholder="请输入数据库端口" />
          </el-form-item>
          <el-form-item label="userName">
            <el-input
              v-model="form.sql.userName"
              placeholder="请输入数据库用户名"
            />
          </el-form-item>
          <el-form-item label="password">
            <el-input
              v-model="form.sql.password"
              placeholder="请输入数据库密码（没有则为空）"
            />
          </el-form-item>
          <el-form-item label="dbName">
            <el-input
              v-model="form.sql.dbName"
              placeholder="请输入数据库名称"
            />
          </el-form-item>
          <el-divider />
          <el-form-item label="缓存类型">
            <el-select v-model="form.cacheType" placeholder="请选择">
              <el-option key="local" label="本地缓存" value="local" />
              <el-option key="redis" label="Redis" value="redis" />
            </el-select>
          </el-form-item>
          <div v-if="form.cacheType == 'redis'">
            <el-form-item label="host">
              <el-input
                v-model="form.cache.host"
                placeholder="请输入Redis链接"
              />
            </el-form-item>
            <el-form-item label="port">
              <el-input
